...
public class sr_clientes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            cliente = new Clientes(Integer.valueOf(request.getParameter("txt_id")),request.getParameter("txt_nombres"),request.getParameter("txt_apellidos"),request.getParameter("txt_telefono"),request.getParameter("txt_ingreso"),request.getParameter("txt_NIT"),request.getParameter("txt_email"),Integer.valueOf(request.getParameter("drop_genero")));
            // Boton agregar 
